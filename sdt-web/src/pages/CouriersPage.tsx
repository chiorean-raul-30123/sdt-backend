    ...
    <section style={{ padding: 16 }}>
      ...
      >
              ...
              <table width="100%" cellPadding={8} style={{borderCollapse:"collapse", marginTop: 12}}>
                ...
                <tbody>
                  ...
                  {data.content.length === 0 && (
                    <tr><td colSpan={6} style={{textAlign:"center", padding:20}}>No couriers.</td></tr>
                  )}
                </tbody>
              </table>
        ...
        <aside style={{ display: "flex", justifyContent: "center" }}>
          <CouriersMap
            height={520}
            couriers={(data?.content ?? []).map((c: any) => ({
              ...c,
              latitude: typeof c.lastLat === "number" ? c.lastLat : null,
              longitude: typeof c.lastLng === "number" ? c.lastLng : null,
            }))}
          />
        </aside>
      </div>
